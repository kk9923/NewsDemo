...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    private void _loadMore() {
     //   System.out.println("mIsLoadingNow=  " + mIsLoadingNow);
     //   System.out.println("onRequestDataListener=  " + (onRequestDataListener=null));
     //   System.out.println("mIsNoMoreData=  " + mIsNoMoreData);
